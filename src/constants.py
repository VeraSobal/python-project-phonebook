...
#строки для вывода при взаимодействии с клиентом
OUTPUT_MESSAGE={"input":"Введите данные", 
                "for_find":"Введите данные для поиска или нажмите ввод для пропуска поля",
                "for_remove":"Для удаления:",
                ...
                "random_input":"Рандомные данные вставлены.\n"}
INPUT_MESSAGE={"id":"Введите id контакта ",
                "all_fields":"Поиск по всем полям = =>", 
               "yn_save":"Сохранить изменения? Y/N => ",
                "yn_random":"Сгенерировать рандомные данные? Y/N => "}
